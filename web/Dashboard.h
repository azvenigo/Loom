...
"",
"This is initialization only - read, don't act. Load context, then stop and wait for an actual",
"request. Don't start running builds, tests, or other work off the strength of this prompt alone.",
"",
...
"that should be addressed later instead of doing it now.",
"",
